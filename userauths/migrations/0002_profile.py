    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijlmnopqrstuwyz', length=7, max_length=25, prefix='')),
                ('conver_image', models.ImageField(default='cover.jpg', upload_to=userauths.models.user_directory_path)),
