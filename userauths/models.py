...
class Profile(models.Model):
    pid = ShortUUIDField(length=7, max_length=25, alphabet='abcdefghijlmnopqrstuwyz')
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    conver_image = models.ImageField(upload_to=user_directory_path, null=True, blank=True, default="cover.jpg")
